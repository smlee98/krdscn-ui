            ...
            <TabContent>
              ...
              <TabPanel value="tutorial">
                <HelpContentArea>
                  ...
                  <HelpCoachProcess>
                    <HelpCoachTask title="1. 주소 조회" isCurrent expandText="전체 2단계">
                      <HelpCoachStep>단계1 : 주소조회</HelpCoachStep>
                      <HelpCoachStep>단계2 : 조회 결과 확인</HelpCoachStep>
                    </HelpCoachTask>
                    <HelpCoachTask title="2. 조회 결과 확인" expandText="전체 2단계">
                      <HelpCoachStep>단계1 : 결과 목록 보기</HelpCoachStep>
                      <HelpCoachStep>단계2 : 상세 정보 확인</HelpCoachStep>
                    </HelpCoachTask>
                  </HelpCoachProcess>
                </HelpContentArea>
              </TabPanel>
