...
function ShadcnInPageNavigationTitle({ className, children }: React.ComponentProps<typeof Krds.InPageNavigationTitle>) {
  return <strong className={cn("text-foreground text-base font-bold", className)}>{children}</strong>
}

function ShadcnInPageNavigationList({ className, children }: React.ComponentProps<typeof Krds.InPageNavigationList>) {
  ...
  return (
    <li className="w-full">
      <a
        ...
        className={cn(
          "hover:bg-accent focus-visible:ring-ring flex w-full items-center rounded-[4px] px-2 py-1 text-sm focus-visible:ring-2 focus-visible:outline-none",
          active ? "bg-accent text-accent-foreground font-bold" : "text-muted-foreground",
          className
        )}
      >
        {children}
...
function ShadcnInPageNavigationDescription({
  ...
  return <p className={cn("text-muted-foreground w-full text-center text-sm", className)}>{children}</p>
}
