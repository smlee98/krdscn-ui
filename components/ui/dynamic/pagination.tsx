...
function ShadcnPaginationJumpInput({
  ...
  return (
    <input
      ...
      className={cn(
        "h-9 w-14 rounded-md border border-input bg-background px-3 text-center text-sm",
...
function ShadcnPaginationJumpTotal({
  ...
  return (
    <span
      className={cn("flex h-9 items-center px-2 text-sm text-muted-foreground", className)}
      {...props}
    >
      /{totalPages}
    </span>
