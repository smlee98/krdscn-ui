  ...
  return (
    <div data-slot="krds-coach-mark-root" className="relative pt-[300px]">
      <div
        ...
        className={cn(
          "relative rounded-[12px] border border-krds-border-primary bg-white p-6",
      ...
      >
        <div
          ...
          className={cn(
            ...
            "rounded-[12px] border-2 border-krds-border-primary bg-white p-6",
        ...
        >
          ...
          <div className="flex flex-col gap-3">
            <h6 className="text-krds-body-sm font-bold text-krds-fg">{title}</h6>
            <p className="text-krds-body-md font-normal text-krds-fg">{description}</p>
          </div>

          <div className="mt-8 flex items-center gap-2">
            <div className="flex items-center gap-1 text-krds-body-md font-bold">
              <span className="sr-only">현재 단계</span>
              <strong className="text-krds-fg-primary">{currentStep}</strong>
              <span aria-hidden="true" className="text-krds-fg">/</span>
              <span className="sr-only">총 단계</span>
              <span className="text-krds-fg">{totalSteps}</span>
            </div>
